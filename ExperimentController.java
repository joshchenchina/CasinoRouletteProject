...
//	ExperimentController.oddsSuite(5000, 2531, 325, "output_odds_4.csv", "single", 200, 1);
    ...
    public static void demo(){
        ExperimentController.run(200000, 1, 1, "config_wheel_1.txt", "config_odds_1.txt");
        ExperimentController.run(200000, 1, 100, "config_wheel_1.txt", "config_odds_1.txt");
        ExperimentController.run(200000, 100, 1, "config_wheel_1.txt", "config_odds_1.txt");
